      ...
      <div className='account-timeline__header'>
        ...
        {!hideTabs && (
          <div className='account__section-headline'>
            ...
            <NavLink onClick="window.location.reload(true)" exact to={`/accounts/${account.get('id')}/bridgesPosts`}><FormattedMessage id='account.posts_homework' defaultMessage='Bridges Posts' /></NavLink>
