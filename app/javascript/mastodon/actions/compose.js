...
export const COMPOSE_GOALS_CHANGE  = 'COMPOSE_GOALS_CHANGE';
...
export function submitCompose(routerHistory) {
  return function (dispatch, getState) {
    ...
    api(getState).post('/api/v1/statuses', {
      ...
      goals: getState().getIn(['compose', 'goals']),
    }, {
      headers: {
...
export function changeComposeGoals(value) {
  return {
    type: COMPOSE_GOALS_CHANGE,
    value,
  };
};
